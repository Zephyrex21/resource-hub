...
// light/dark theme with no extra logic.
export function HeroIllustration() {
  return (
    <svg viewBox="0 0 440 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full" aria-hidden="true">
      ...
      {/* backdrop glow */}
      <circle cx="220" cy="200" r="180" className="fill-accent-notes/[0.07]" />
      ...
      {/* junction nodes */}
      <circle cx="246" cy="84" r="4.5" className="fill-accent-tips" />
      <circle cx="330" cy="188" r="4.5" className="fill-accent-projects" />
      <circle cx="148" cy="268" r="4.5" className="fill-accent-notes" />

      {/* floating decorative dots */}
      <circle cx="392" cy="70" r="3" className="fill-accent-projects/50" />
      <circle cx="46" cy="230" r="3" className="fill-accent-tips/50" />
      <circle cx="368" cy="320" r="3" className="fill-accent-notes/50" />
      <circle cx="70" cy="60" r="3" className="fill-accent-projects/40" />
