...
import { noteCreateSchema, noteUpdateSchema } from '../schemas/noteSchema.js'
...
router.post('/', requireAdmin, validate(noteCreateSchema), ctrl.create)
router.put('/:id', requireAdmin, validate(noteUpdateSchema), ctrl.update)
